...
>(({ className, ...props }, forwardedRef) => (
  <table
    ...
    className={cx(
      // base
      "w-full table-fixed caption-bottom border-b",
      // border color
...
>(({ className, ...props }, forwardedRef) => (
  <th
    ...
    className={cx(
      // base
      "border-b px-6 py-3.5 text-left text-sm font-semibold",
      // text color
...
>(({ className, ...props }, forwardedRef) => (
  <td
    ...
    className={cx(
      // base
     "py-4 px-6 text-sm text-gray-600 dark:text-gray-400 truncate",
      className,
    )}
    {...props}
  />
